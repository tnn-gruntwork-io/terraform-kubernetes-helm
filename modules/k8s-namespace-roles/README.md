...
* See the [examples](https://github.com/tnn-gruntwork-io/terraform-kubernetes-helm/tree/master/examples) folder for example
  usage.
* See [variables.tf](https://github.com/tnn-gruntwork-io/terraform-kubernetes-helm/blob/master/modules/k8s-namespace-roles/variables.tf)
  for all the variables you can set on this module.
* See [outputs.tf](https://github.com/tnn-gruntwork-io/terraform-kubernetes-helm/blob/master/modules/k8s-namespace-roles/outputs.tf)
